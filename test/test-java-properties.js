...
describe('generator-alfresco-common:java-properties', function () {
  ...
  it('can handle single basic kv pair', function () {
    ...
    assert.deepStrictEqual(props, { key: 'value' });
  });
