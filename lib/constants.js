...
module.exports = {
  CUSTOMIZATIONS_GROUP_ID: 'org.alfresco.maven',
  CUSTOMIZATIONS_ARTIFACT_ID: 'customizations',
  CUSTOMIZATIONS_VERSION: '1.0.0-SNAPSHOT',
  ...
  FOLDER_INTEGRATION_TESTS: 'integration-tests',
  FOLDER_MODULES: 'modules',
  FOLDER_MODULES_PLATFORM: 'platform',
  FOLDER_MODULES_SHARE: 'share',
  FOLDER_REPO: 'repo',
  ...
  PROJECT_STRUCTURES: ['advanced', 'basic'],
