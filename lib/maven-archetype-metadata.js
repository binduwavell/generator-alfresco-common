...
module.exports = function (archetypeMetadataString) {
   ...
   *
   * @returns {!string}
   * @throws {TypeError} if name is not defined or XML is not an archetype-descriptor
   */
  ...
  /**
   * Reads any requiredProperty elements and produces a map with the @key attribute mapped
