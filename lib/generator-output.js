...
module.exports = function (yo) {
  ...
  module.width = function () {
    if (module.size && module.size.width) return module.size.width;
    return DEFAULT_WIDTH;
  };

  module.info = function (message) {
    yo.log(wrap(chalk.bold(chalk.green('INFO:  ') + message), module.width()));
    debug('INFO:  ' + message);
  };

  module.warn = function (message) {
    yo.log(wrap(chalk.bold(chalk.yellow('WARN:  ') + message), module.width()));
    debug('WARN:  ' + message);
  };

  module.error = function (message) {
    yo.log(wrap(chalk.bold(chalk.red('ERROR: ') + message), module.width()));
    debug('ERROR :  ' + message);
  };
  ...
  module.docs = function (text, link) {
    if (text) {
      ...
      yo.log(wrap(chalk.dim.yellow(t), module.width()));
    }
    if (link) {
  ...
  module.definition = function (term, def) {
    yo.log(wrap(chalk.bold.yellow(term + ': ') + chalk.dim.yellow(def), module.width()));
  };
